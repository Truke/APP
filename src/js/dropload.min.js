...
!
    function (a) {
        ...
        function h(b) {
            ...
            }), b.$domResult.html("").append(b.opts.domUp.domLoad), i(b)) : b.$domResult.css({
                height: "0"
        ...
        function m(a) {
            "" != a.opts.touchend && a.opts.touchend(a);
        }
        function i(a) {
            a.loading = !0,
                ...
                d.opts = a.extend({},
                    {
                        ...
                        domUp: {
                            ...
                            domLoad: '<div class="dropload-load"><span class="loading"></span><span>加载中...</span></div>'
                        },
                        domDown: {
                    ...
                    d.$element.on("touchstart",
                        function (a) {
                            d.loading || d.isLock || m(d) || (e(a), f(a, d))
                        }),
